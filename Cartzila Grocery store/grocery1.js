...
function displayitems()
{
    grocery.forEach((product)=>{
        ...
        <div class="card shadow">
          <button type="button" class="btn btn-light mb-0" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist" style="height: 40px;width: 40px;border-radius: 50%;margin-left:auto;">
          ...
          <div class="card-body">
            <p class="card-text text-muted lh-1">${product.desc}</p>
            <h6 class="card-title mb-3 lh-1">${product.name}</h6>
            <div class="d-flex add">   
            <p class="text-primary flex-grow-1">$${product.price}</p> 
            <div class="hide"> 
            <button type="button" class="btn btn-danger" onclick="addtocart(${product.id})">+ <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
