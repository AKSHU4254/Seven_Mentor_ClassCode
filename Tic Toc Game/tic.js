...
else if((b4=='x' || b4=='X') && (b5=='x'|| b5=='X') && (b6=='x' || b6=='X'))
{
    ...
    // checking for player 0 start , is player O won or
    // not and after that disable all the other field
}
...
// here onword, function check turn of the player
// and put according value X or O
